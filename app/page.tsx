  ...
  return (
    <div className="lp" ref={wrapRef}>
      ...
      <section className="hero">
        ...
        <div className="hero-network h-mockup" aria-hidden="true">
          <ParticleNetwork />
        </div>
        </div>
      </section>
          ...
          <div className="ft-cols">
            ...
            <div>
              ...
              <div className="ft-col-links">
                ...
                <a href="https://discord.gg/TKUgsqRqTg">Discord</a>
          ...
          <div className="ft-brand">
            ...
            <div className="ft-social-row">
              ...
              <a href="https://discord.gg/TKUgsqRqTg" className="ft-social-btn" aria-label="Discord">
                <svg viewBox="0 0 16 16" fill="currentColor"><path d="M13.54 3.4A13.2 13.2 0 0 0 10.3 2.4a.05.05 0 0 0-.05.02c-.14.25-.3.57-.41.82a12.2 12.2 0 0 0-3.67 0 8.3 8.3 0 0 0-.42-.82.05.05 0 0 0-.05-.02 13.17 13.17 0 0 0-3.24 1A.05.05 0 0 0 2.44 3.4C.93 5.7.5 7.94.72 10.15a.05.05 0 0 0 .02.04 13.3 13.3 0 0 0 4 2.02.05.05 0 0 0 .06-.02c.31-.42.58-.87.82-1.34a.05.05 0 0 0-.03-.07 8.74 8.74 0 0 1-1.25-.6.05.05 0 0 1-.01-.08l.25-.2a.05.05 0 0 1 .05-.01c2.62 1.2 5.46 1.2 8.05 0a.05.05 0 0 1 .05.01l.25.2a.05.05 0 0 1-.01.08 8.2 8.2 0 0 1-1.25.59.05.05 0 0 0-.03.07c.24.47.52.92.82 1.34a.05.05 0 0 0 .06.02 13.26 13.26 0 0 0 4.01-2.02.05.05 0 0 0 .02-.03c.27-2.57-.46-4.8-1.93-6.76a.04.04 0 0 0-.02-.02zM5.68 8.9c-.79 0-1.44-.73-1.44-1.62s.64-1.62 1.44-1.62c.8 0 1.45.73 1.44 1.62 0 .9-.64 1.62-1.44 1.62zm5.33 0c-.79 0-1.44-.73-1.44-1.62s.64-1.62 1.44-1.62c.8 0 1.45.73 1.44 1.62 0 .9-.63 1.62-1.44 1.62z"/></svg>
              </a>
            </div>
          </div>
