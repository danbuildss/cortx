...
create index on public.services (next_check_at) where deleted_at is null;
...
create index on public.alert_configs (service_id);
create index on public.alert_configs (user_id);
